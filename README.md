# config-core [![GitHub license](https://img.shields.io/github/license/erichosick/config-core?style=flat)](https://github.com/erichosick/config-core/blob/master/LICENSE) [![Tests](https://github.com/erichosick/config-core/workflows/CI/badge.svg)](https://github.com/erichosick/config-core/actions) [![codecov](https://codecov.io/gh/erichosick/config-core/branch/master/graph/badge.svg)](https://codecov.io/gh/erichosick/config-core) ![npm](https://img.shields.io/npm/v/config-core) [![minizipped size](https://badgen.net/bundlephobia/minzip/config-core)](https://bundlephobia.com/result?p=config-core)
